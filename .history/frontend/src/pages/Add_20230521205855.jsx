...
export default function Add() {
  ...
  return (
    <div className="mx-auto mt-6 flex flex-col rounded-lg border border-[#e1e0e0] bg-[#e8e8e8] p-4 items-center justify-center gap-5">
      ...
      <input className='p-2 rounded-lg shadow-sm' type="text" palceholder="title" name="title" onChange={handleChange} />
      ...
      <button className="bg-[#f9f7f7] p-2 rounded-lg shadow-sm justify-start flex px-4" onClick={handleClick}>
        Add
      </button>
    </div>
  )
