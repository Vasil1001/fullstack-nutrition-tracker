        ...
        {books.map((book) => (
          <div className="flex flex-col rounded-lg bg-[#eae8e8] p-4" key={book.id}>
            ...
            <div className="flex flex-col gap-2 mt-2">
              <button className="bg-[#f9f7f7] rounded-lg shadow-sm border border-emerald-300 hover:border-emerald-400">Update</button>
              <button className="bg-[#f9f7f7] rounded-lg shadow-sm border border-red-200 hover:border-red-300">Delete</button>
            </div>
          </div>
        ))}
      </div>
