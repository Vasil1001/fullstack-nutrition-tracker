        ...
        {books.map((book) => (
          <div className="flex flex-col rounded-lg border border-[#e1e0e0] bg-[#e8e8e8] p-4" key={book.id}>
            ...
            <div className="flex  gap-2 mt-2">
              <button className="bg-[#f9f7f7] rounded-lg grow shadow-sm border hover:border-gray-300">Update</button>
              <button className="bg-[#f9f7f7] rounded-lg shadow-sm border  hover:border-red-200"><BsTrash3/></button>
            </div>
          </div>
        ))}
      </div>
